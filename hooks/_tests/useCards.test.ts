...
describe('useCards', () => {
    ...
    it('should reset and set loading when fetching cards', async () => {
        const mockReader = {
            read: vi
                .fn()
        ...
        await act(async () => {
            await result.current.fetchCards('4 Lightning Bolt')
        })
    ...
    it('should handle streaming progress events', async () => {
        ...
        const progressData = {
            ...
            card: { id: '1', name: 'Lightning Bolt', cmc: 1, quantity: 4 }
        }
    ...
    it('should call fetch with correct parameters', async () => {
        ...
        await act(async () => {
            await result.current.fetchCards(decklist)
        })
